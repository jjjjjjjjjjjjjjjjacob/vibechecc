...
export const smileysEmojisAll: Omit<Emoji, 'sentiment'>[] = [
  {
    emoji: '😀',
    name: 'grinning face',
  ...
  },
  {
    emoji: '💀',
    name: 'skull',
    keywords: ['body', 'dead', 'death', 'face', 'fairy', 'fairytale', 'i’m', 'lmao', 'monster', 'tale', 'yolo'],
    category: 'smileys',
    subcategory: 'face-negative',
    unicode: '1F480',
    version: '0.6',
  ...
  },
  {
    emoji: '👻',
    name: 'ghost',
    keywords: ['boo', 'creature', 'excited', 'face', 'fairy', 'fairytale', 'fantasy', 'halloween', 'haunting', 'monster', 'scary', 'silly', 'tale'],
    category: 'smileys',
    subcategory: 'face-costume',
    unicode: '1F47B',
    version: '0.6',
  ...
  },
  {
    emoji: '👽️',
    name: 'alien',
    keywords: ['creature', 'extraterrestrial', 'face', 'fairy', 'fairytale', 'fantasy', 'monster', 'space', 'tale', 'ufo'],
    category: 'smileys',
    subcategory: 'face-costume',
    unicode: '1F47D',
    version: '0.6',
