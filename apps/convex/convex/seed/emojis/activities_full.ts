...
export const activitiesEmojisAll: Omit<Emoji, 'sentiment'>[] = [
  {
    emoji: '🎃',
    name: 'jack-o-lantern',
  ...
  },
  {
    emoji: '🎯',
    name: 'bullseye',
    keywords: ['bull', 'dart', 'direct', 'entertainment', 'game', 'hit', 'target'],
    category: 'activities',
    subcategory: 'game',
    unicode: '1F3AF',
    version: '0.6',
  ...
  },
  {
    emoji: '🪅',
    name: 'piñata',
    keywords: ['candy', 'celebrate', 'celebration', 'cinco', 'de', 'festive', 'mayo', 'party', 'pinada', 'pinata'],
    category: 'activities',
    subcategory: 'game',
    unicode: '1FA85',
    version: '13',
